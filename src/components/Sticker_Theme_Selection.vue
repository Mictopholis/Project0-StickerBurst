<template>
  ...
  <div v-if="!buttonSelected">
      ...
      <div v-if="tierlevel0">
          <v-btn depressed small color="error" @click="RandomFunction()">
          ...
          <v-layout row wrap>
            ...
            <v-flex xs12 sm3>
              <v-btn flat large @click="ClickFunction(5)">
                <img src="sticker/BB/0EEE2397DA2911D79A6F1E896E8563B637667339_size8_w240_h240.gif" />
              </v-btn>
            </v-flex>
  ...
  export default {
    ...
    methods: {
      ...
      EventFunction: function () {
        this.doPlaceStickers = true
        this.buttonSelected = false
        App.env = true
        App.theme = this.theme
        App.numStickers = 0
        alert("Sticker theme selected! Now enter the number of stickers you want!")
      },
      RandomFunction: function () {
        ...
        App.numStickers = 0
        App.theme = "Random"
        alert("Randomized sticker theme selected! Now upload a picture!")
      },
  }
  }
